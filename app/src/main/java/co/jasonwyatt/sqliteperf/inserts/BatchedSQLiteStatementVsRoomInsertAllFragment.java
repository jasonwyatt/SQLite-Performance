...
public class BatchedSQLiteStatementVsRoomInsertAllFragment extends TestSuiteFragment {
    @Override
    ...
    protected Map<TestScenarioMetadata, TestCase[]> getTestScenarios() {
        ...
        result.put(new TestScenarioMetadata("simple Batched SQLiteStatement", 0xFFb71c1c, 3), new TestCase[]{
        ...
        result.put(new TestScenarioMetadata("tracks Batched SQLiteStatement", 0xFF4a148c, 3), new TestCase[] {
